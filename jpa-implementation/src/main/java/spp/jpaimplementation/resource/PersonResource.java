...
import spp.jpaimplementation.service.PersonServiceImpl;
...
public class PersonResource {
    ...
    @ApiOperation(value = "Returns created Person Data Transfer Object", response = PersonDto.class)
    ...
    @ApiOperation(value = "Returns Person Data Transfer Object filtered by Id", response = PersonDto.class)
    ...
    @ApiOperation(value = "Returns All Person Data Transfer Objects", response = PersonDto.class)
    ...
    @ApiOperation(value = "Returns Updated Person Data Transfer Object", response = PersonDto.class)
    ...
    @ApiOperation(value = "Deletes Person Data Transfer Object", response = PersonDto.class)
    ...
    @ApiOperation(value = "Returns All Person Data Transfer Objects filtered by name", response = PersonDto.class)
    ...
    @ApiOperation(value = "Returns All Person Data Transfer Objects filtered by assigned task", response = PersonDto.class)
